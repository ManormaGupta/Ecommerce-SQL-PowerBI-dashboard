...
- `sql/ecommerce_db_project.sql` — full SQL script (table creation, data insertion, and analysis queries)
- `powerbi/ecommerce_dashboard.pbix` — Power BI dashboard file
